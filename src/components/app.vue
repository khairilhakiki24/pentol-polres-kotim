		...
		<f7-views tabs class="safe-areas">
			...
			<f7-toolbar tabbar labels bottom>
				...
				<f7-link
					...
					icon-ios="f7:exclamationmark_circle_fill"
					icon-aurora="f7:exclamationmark_circle_fill"
					icon-md="f7:exclamationmark_circle_fill"
					text="Tentang"
				></f7-link>
			</f7-toolbar>
...
export default {
	setup() {
		...
		const f7params = {
			name: 'Cobest App', // App name
			theme: 'auto', // Automatic theme detection

			id: 'io.framework7.cobest', // App bundle ID
			// App store
			store: store,
			// App routes
			routes: routes,
